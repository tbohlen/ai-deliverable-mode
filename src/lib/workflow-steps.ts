...
export const workflowSteps: WorkflowStep[] = [
  ...
  },
  {
    ...
    aiDescription: "AI helps user understand key decisions and knowledge required for defense",
  ...
  },
  {
    ...
    aiDescription: "AI role-plays as stakeholder to simulate presentation scenarios",
